...
Similarity ≥ 0.30 인 기록만 LLM context로 전달

이를 통해 불필요한 context 전달을 줄이고,
맥락 정확도 및 응답 신뢰도를 개선했습니다.
...
Resona 2.0은 단순 질의응답형 RAG 시스템을 넘어,
chunk를 적용하여 일기를 길게 쓴 경우에도 정확한 답변 및
사용자의 일기 데이터를 집계·구조화·분석하여
생활 패턴과 감정 흐름을 해석하는 분석형 AI 엔진입니다.

Resona 1.0이 “과거 기록을 찾아 답하는 AI”였다면,
Resona 2.0은 “기억을 분석해 인사이트를 제공하는 AI”를 목표로 합니다.
